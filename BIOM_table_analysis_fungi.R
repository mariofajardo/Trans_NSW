...
OTUS<-import_biom(BIOMfilename = 'DATA/otu_table_mc2_w_tax.biom',version = 1.9)
...
print(ggplot(dat[dat$Site%in%0:26,],
             aes(x=Site*50,y=simpson_div,group=System,colour=System))+
        geom_point(size=3)+
        ...
        ggtitle(label = 'Transect NS first 13 sites, Simpson diversity')+
